    ...
    <section class="no-padding-top">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="block">
                        <div class="title"><strong>Add Course</strong>
                            <a class="btn btn-danger float-right" href="{{ route('admin.course') }}">Cancel</a>
                        </div>
                        <div class="block-body">
                            <form class="form-horizontal" wire:submit.prevent="addCourse()">
                                <div class="line"></div>
                                ...
                                <div class="form-group row" wire:ignore>
                                    ...
                                    <div class="col-sm-9">
                                        <select class="select2 select2-hidden-accessible" id="teachers"
                                            ...
                                            style="width: 100%;" name="teachers[]" wire:model="sel_teachers">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" id="level" name="teachers[]"
                                            wire:model="level_id">
