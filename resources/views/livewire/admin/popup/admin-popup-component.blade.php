<div>
    ...
    <div class="page-header no-margin-bottom">
        <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Popup Element</h2>
        </div>
    </div>
    <!-- Breadcrumb-->
    <div class="container-fluid">
    ...
    <section class="no-padding-top">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="block">
                        <div class="title"><strong>Update Popup</strong>
                            <a class="btn btn-danger float-right" href="{{ route('admin.dashboard') }}">Cancel</a>
                        </div>
                        <div class="block-body">
                            <form class="form-horizontal" wire:submit.prevent="updatePopup()">
                                <div class="line"></div>
                                <div class="form-group row @error('newimage') has-danger @enderror">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        @else
                                            <img src="{{ asset('/storage/popups') }}/{{ $image }}" width="80"
                                                alt="">
                                        @endif
                                        @error('newimage')
