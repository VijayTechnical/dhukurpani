<div>
    ...
    <section id="teachers-page" class="pt-90 pb-120 gray-bg">
        <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="courses-top-search">
                        <ul class="nav float-left" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">Showning {{ $galleries->count() }} 0f {{ $paginate }}
                                Results</li>
                        </ul> <!-- nav -->
                    ...
                    @foreach ($galleries as $key => $gallery)
                        <div class="col-lg-3 col-sm-6">
                            <div class="singel-teachers mt-30 text-center">
                                ...
                                <div class="cont">
                                    <a href="{{ route('gallery.detail', ['gallery_slug' => $gallery->slug]) }}">
                                        <h6>{{ $gallery->name }}</h6>
                                    </a>
            ...
            @else
                <p class="text-center text-black-500 mt-20">No galleries found</p>
            @endif
            <div class="row">
                <div class="col-lg-12">
